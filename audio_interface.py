...
class Ws_Param(object):
    ...
    def __init__(self, APPID, APIKey, APISecret, AudioFile):
        ...
        self.BusinessArgs = {"domain": "iat", "language": "zh_cn", "accent": "cantonese", "vinfo": 1, "vad_eos": 10000}
...
class SpeechRecognizer:
    ...
    def recognize(self, audio_path):
        global wsParam
        wsParam = Ws_Param(APPID=self.app_id, APISecret=self.api_secret, APIKey=self.api_key, AudioFile=audio_path)
...
def get_random_audio_file(folder_path, file_extension=".mp3"):
    ...
    """
    # 获取指定文件夹中所有音频文件的列表
    audio_files = [file for file in os.listdir(folder_path) if file.endswith(file_extension)]
